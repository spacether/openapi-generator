...
public class CodegenParameter implements IJsonSchemaValidationProperties {
    ...
    public CodegenParameter copy() {
        ...
        if (this.composedSchemas != null) {
            output.composedSchemas = this.composedSchemas;
        }

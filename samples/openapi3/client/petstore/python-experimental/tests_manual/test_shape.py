...
class TestShape(unittest.TestCase):
    ...
    def testShape(self):
        ...
        with self.assertRaisesRegex(
                ...
                'Shape is missing required input data in args or kwargs'
        ):
            Shape()

        # invalid shape_type (first discriminator). 'Circle' does not exist in the model.
        err_msg = (
            r"Invalid inputs given to generate an instance of <class 'petstore_api.model.shape.Shape'>. None of the "
            r"oneOf schemas matched the input data."
        )
        with self.assertRaisesRegex(
        ...
        err_msg = (
            r"Invalid inputs given to generate an instance of "
            r"<class 'petstore_api.model.quadrilateral.Quadrilateral'>. "

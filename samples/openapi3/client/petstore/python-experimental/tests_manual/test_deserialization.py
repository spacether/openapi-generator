...
class DeserializationTests(unittest.TestCase):
    ...
    def test_deserialize_shape(self):
        ...
        self.assertEqual(deserialized.shapeType, shape_type)
        self.assertEqual(deserialized.triangleType, triangle_type)
    ...
    def test_deserialize_float_value(self):
        ...
        self.assertTrue(isinstance(deserialized.lengthCm, float))
        ...
        deserialized = self.deserialize(response, (banana.Banana,), True)
        self.assertTrue(isinstance(deserialized, banana.Banana))
        self.assertTrue(isinstance(deserialized.lengthCm, int))
    ...
    def test_deserialize_with_additional_properties(self):
        ...
        err_msg = (r"{} was passed 1 invalid argument: \['{}'\]")
        with self.assertRaisesRegex(

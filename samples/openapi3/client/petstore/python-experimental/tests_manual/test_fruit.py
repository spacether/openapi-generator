    ...
    def testFruit(self):
        ...
        self.assertEqual(
            fruit,
            {
                'color': color,
                'lengthCm': length_cm,
                'additional_string': kwargs['additional_string'],
                'additional_date': date(2021, 1, 2)
            }
        )
        # without _from_server, additional_date will be a str
        del kwargs['_from_server']
        fruit = Fruit(**kwargs)
        self.assertEqual(
            fruit,
            {
                ...
                'lengthCm': length_cm,
                'additional_string': kwargs['additional_string'],
                'additional_date': kwargs['additional_date']
            }
        )
